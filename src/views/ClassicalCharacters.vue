...
export default {
  ...
  data() {
    return {
      examples: [
        { name: '李白', source: '《论语》："白圭之玷，尚可磨也"，取"白"字，与姓氏搭配，寓意纯洁如白玉', category: '儒家经典' },
        { name: '王维', source: '《易经》："地势坤，君子以厚德载物"，取"维"字，寓意德行深厚，能够承载重任', category: '儒家经典' },
        { name: '苏轼', source: '《诗经》："高山仰止，景行行止"，取"轼"字，寓意高尚品德，令人敬仰', category: '儒家经典' }
      ]
    }
  },
  methods: {
...
.classics-wrapper, .philosophy-wrapper, .historical-wrapper {
  display: grid;
...
.classics-card, .philosophy-card, .historical-card {
