      ...
      <div class="traditions-grid">
        ...
        <div class="tradition-card">
          ...
          <div class="tradition-content">
            ...
            <p><strong>Miao Hao (庙号):</strong> Temple name used for ancestor worship after an emperor's death</p>
        ...
        <div class="tradition-card">
          ...
          <div class="tradition-content">
            ...
            <p><strong>Identification Function:</strong> Generation names allowed quick identification of generational relationships within the clan, facilitating clan management</p>
