...
.structures-wrapper, .strokes-wrapper, .meaning-wrapper, .examples-wrapper, .practice-wrapper, .contemporary-wrapper {
  display: grid;
...
.structure-card, .stroke-card, .meaning-card, .example-card, .practice-card, .contemporary-card {
